...
namespace BlastFrame.Gameplay.Player
{
    ...
    public class PlayerStats : MonoBehaviour
    {
        ...
        [Tooltip("Horizontal air drag per second applied to momentum (dash-jump bleed). ~2.")]
        [SerializeField] private FloatReference airDrag = new FloatReference(2f);
        ...
        [Tooltip("Seconds after leaving ground a jump still counts (coyote time). ~0.1.")]
        [SerializeField] private FloatReference coyoteTime = new FloatReference(0.1f);
        ...
        [SerializeField] private FloatReference dashDuration = new FloatReference(0.72f);
        ...
        [SerializeField] private FloatReference wallSlideSpeed = new FloatReference(3f);
